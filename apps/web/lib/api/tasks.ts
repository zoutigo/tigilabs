...
export const mockTasks: Task[] = [
  {
    ...
    description:
      "Prioriser les modules internes apres le socle utilisateurs et taches.",
    status: "IN_PROGRESS",
    priority: "HIGH",
    assignee: {
      id: "user-admin",
  ...
  },
  {
    ...
    description:
      "Cartographier les droits requis pour les prochains modules internes.",
    status: "TODO",
    priority: "MEDIUM",
  },
  {
    ...
    description:
      "Lister les objets metier et contraintes de reporting financier.",
    status: "REVIEW",
    priority: "URGENT",
  },
];
